...
import (
	...
	"main.go/plugins/world_mirror/server/event"
	"main.go/plugins/world_mirror/server/item"
	"main.go/plugins/world_mirror/server/item/enchantment"
	"main.go/plugins/world_mirror/server/item/inventory"
	"main.go/plugins/world_mirror/server/player/bossbar"
	"main.go/plugins/world_mirror/server/player/chat"
	"main.go/plugins/world_mirror/server/player/form"
	"main.go/plugins/world_mirror/server/player/scoreboard"
	"main.go/plugins/world_mirror/server/player/skin"
	"main.go/plugins/world_mirror/server/player/title"
