...
import (
	...
	"main.go/plugins/chunk_mirror/server/entity/damage"
	"main.go/plugins/chunk_mirror/server/entity/effect"
	"main.go/plugins/chunk_mirror/server/entity/healing"
	"main.go/plugins/chunk_mirror/server/entity/physics"
	"main.go/plugins/chunk_mirror/server/event"
	"main.go/plugins/chunk_mirror/server/item"
	"main.go/plugins/chunk_mirror/server/item/enchantment"
	"main.go/plugins/chunk_mirror/server/item/inventory"
	"main.go/plugins/chunk_mirror/server/player/bossbar"
	"main.go/plugins/chunk_mirror/server/player/chat"
	"main.go/plugins/chunk_mirror/server/player/form"
	"main.go/plugins/chunk_mirror/server/player/scoreboard"
	"main.go/plugins/chunk_mirror/server/player/skin"
	"main.go/plugins/chunk_mirror/server/player/title"
